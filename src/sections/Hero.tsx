...
export const HeroSection = () => {
  return (
    <div className="py-32 md:py-48 md:mt-10 lg:py-60 lg:mt-0  relative z-0 overflow-x-clip">
      <div
      ...
      >
        ...
        <HeroOrbit
          ...
          spinDuration="6s"
        >
          <div className="size-5 rounded-full bg-emerald-500/20" />
        </HeroOrbit>
        <HeroOrbit
          size={800}
          rotation={-72}
      ...
      <div className="container">
        ...
        <div className="max-w-lg mx-auto">
          <h1 className="font-serif text-3xl text-center mt-8 tracking-wide md:text-5xl">
            Building Exceptional WebSites &WebDesigns
          </h1>
